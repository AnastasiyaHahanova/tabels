...
final class Version20201108193425 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE table_value (id INT AUTO_INCREMENT NOT NULL, table_id_id INT NOT NULL, row VARCHAR(255) NOT NULL, `column` VARCHAR(255) NOT NULL, value DOUBLE PRECISION NOT NULL, INDEX IDX_118B954C73B8532F (table_id_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
